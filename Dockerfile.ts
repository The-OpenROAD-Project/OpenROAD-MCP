...
# Cross-implementation golden fixtures live at <repo>/python/tests/golden
# (generated by the Python impl); the golden tests locate them by walking up, so
# /app/tests/golden is found from /app/__tests__/golden.
COPY python/tests/golden ./tests/golden
ENV PATH="/OpenROAD-flow-scripts/tools/install/OpenROAD/bin:/OpenROAD-flow-scripts/tools/install/yosys/bin:$PATH" \
    ORFS_FLOW_PATH=/OpenROAD-flow-scripts/flow
